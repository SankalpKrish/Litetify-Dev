...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::api_get_me,
            api::api_create_playlist,
            api::api_update_playlist,
            ...
            api::api_check_follow_artist,
            api::api_follow_artist,
            api::api_unfollow_artist,
            api::api_follow_playlist,
            api::api_unfollow_playlist,
            api::api_get_top_artists,
            api::api_get_top_tracks,
            api::api_get_saved_shows,
            api::api_get_show,
            api::api_get_show_episodes,
            api::api_save_show,
            api::api_remove_show,
